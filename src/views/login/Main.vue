<template>
    <section class="bg-gray-50 w-full h-screen flex items-center justify-center dark:bg-gray-900">
        ...
        <svg class="w-5 h-5 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const handleSubmit = async (e) => {
    ...
    if ( data.email === '' || data.password === '') {
        ...
        try {
            axios.post('https://ho-tel.1kb.uz/api/Admin/login-admin', data)
